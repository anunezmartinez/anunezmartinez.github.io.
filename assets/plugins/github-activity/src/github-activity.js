      ...
      if (p.commits) {
        ...
        p.commits.forEach(function(d, i) {
          ...
          if (i < 2) {
            ...
            d.committerGravatar = Mustache.render('<img class="gha-gravatar-commit" src="https://avatars3.githubusercontent.com/u/55793100?v=4" width="16" />', { hash: md5(d.author.email) });
          } else {
